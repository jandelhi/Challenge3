...
var _TicketForm = __webpack_require__(27);

var _TicketForm2 = _interopRequireDefault(_TicketForm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_TicketForm2.default, null), document.getElementById('root-ticket-form'));
...
var TicketForm = function (_Component) {
    _inherits(TicketForm, _Component);

    function TicketForm() {
        _classCallCheck(this, TicketForm);

        var _this = _possibleConstructorReturn(this, (TicketForm.__proto__ || Object.getPrototypeOf(TicketForm)).call(this));
        ...
        _this.checkValidations = _this.checkValidations.bind(_this);
        _this.clearErrorMessages = _this.clearErrorMessages.bind(_this);
        return _this;
    }

    _createClass(TicketForm, [{
        key: "handleSubmit",
        value: function handleSubmit(e) {
            e.preventDefault();
            document.getElementById("success").innerHTML = "";
            var fields = Object.keys(this.state);
        ...
        value: function clearErrorMessages(fields) {
        ...
        value: function checkValidations(fields) {
            this.clearErrorMessages(fields);
            var isValid = true;
            var elems = document.getElementById("ticketForm").elements;
            console.dir(fields);
            console.dir(elems);

            fields.map(function (field) {
                console.dir(elems[field]);
                var f = elems[field];
                if (f.validity) {
                    if (!f.validity.valid) {
                        isValid = false;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "form",
                    { id: "ticketForm", noValidate: true, onSubmit: this.handleSubmit },
                    _react2.default.createElement(
                        "span",
                        null,
                        " First Name ",
                        _react2.default.createElement("input", { type: "text", id: "firstName", onChange: this.handleFieldChange,
                            placeholder: "Name", value: this.state.firstName,
                            required: true })
                    ),
                    _react2.default.createElement("div", { id: "firstName-error" }),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement(
                        "span",
                        null,
                        " Last Name ",
                        _react2.default.createElement("input", { type: "text", id: "lastName", onChange: this.handleFieldChange,
                            placeholder: "Last Name", value: this.state.lastName,
                            required: true })
                    ),
                    _react2.default.createElement("div", { id: "lastName-error" }),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement(
                        "span",
                        null,
                        " Tickets ",
                        _react2.default.createElement("input", { type: "number", id: "tickets", onChange: this.handleFieldChange,
                            value: this.state.tickets, min: "1", max: "8",
                            required: true })
                    ),
                    _react2.default.createElement("div", { id: "tickets-error" }),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement(
                        "span",
                        null,
                        " Card Info ",
                        _react2.default.createElement("input", { type: "text", id: "cardInfo", placeholder: "1010 8800 1111 1234",
                            onChange: this.handleFieldChange, value: this.state.cardInfo,
                            maxLength: "16", minLength: "16", pattern: "[0-9]{16}",
                            required: true })
                    ),
                    _react2.default.createElement("div", { id: "cardInfo-error" }),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement(
                        "span",
                        null,
